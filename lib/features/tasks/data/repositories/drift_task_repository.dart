      ...
      await _database
          ...
          .insertOnConflictUpdate(
            TasksCompanion.insert(
              ...
              alarmEnabled: Value(draft.alarmEnabled),
              ...
              emergencyContact1: Value(
                draft.emergencyContactNumbers.elementAtOrNull(0)?.trim() ?? '',
              ),
              emergencyContact2: Value(
                draft.emergencyContactNumbers.elementAtOrNull(1)?.trim() ?? '',
              ),
              emergencyContact3: Value(
                draft.emergencyContactNumbers.elementAtOrNull(2)?.trim() ?? '',
              ),
              emergencyEmail: Value(draft.emergencyEmail.trim()),
  ...
  PlannerTask _mapTask(TaskRecord row) {
    return PlannerTask(
      ...
      emergencyContactNumbers: [
        row.emergencyContact1,
        row.emergencyContact2,
        row.emergencyContact3,
      ].where((number) => number.trim().isNotEmpty).toList(),
